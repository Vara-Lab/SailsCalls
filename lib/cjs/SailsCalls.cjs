...
var decimal = require('./node_modules/decimal.js/decimal.cjs');
...
class SailsCalls {
    ...
    voucherBalance = (voucherId) => {
        return new Promise(async (resolve) => {
            ...
            const balance = new decimal.Decimal(voucherBalance.toString());
            const oneVara = new decimal.Decimal('1000000000000');
